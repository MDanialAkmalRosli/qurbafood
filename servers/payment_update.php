...
if ($paidstatus=="true"){
  ...
  $signing = '';
    ...
    $sqlinsert = "INSERT INTO tbl_purchased(orderid, email, paid, status) VALUES ('$receiptid', '$userid', '$amount', 'paid')";
    ...
    echo '<br><br><body><div><h2><br><br><center>Your Receipt</center>
     ...
     <p><center>Press back button to return to QurbaFood app.</center></p></div></body>';
}
else{
    echo '<br><br><body><div><h2><br><br><center>Your Receipt</center>
     </h1>
